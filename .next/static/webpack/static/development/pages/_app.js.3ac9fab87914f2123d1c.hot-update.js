...
var LayOut = function LayOut(_ref4) {
  ...
  return __jsx(MainLayout, {
    ...
    onClick: function onClick() {
      MblNavref.current.style.left = "-57px";
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
