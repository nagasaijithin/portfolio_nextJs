...
})(["height:100%;width:40%;position:fixed;background:white;z-index:30;box-shadow:1px 1px 10px black;left:-57%;& > div{width:100%;height:100%;display:flex;flex-direction:column;& > div:nth-child(1){height:10%;display:flex;align-items:center;justify-content:center;font-size:3rem;}& > div:nth-child(2){flex:1;display:flex;font-size:4rem;align-items:center;justify-content:center;text-align:center;& > ul{list-style:none;& > li{padding:2rem;cursor:pointer;-webkit-text-stroke-color:var(--blackTextColor);-webkit-text-stroke-width:0.5px;-webkit-text-fill-color:transparent;position:relative;&:hover{& > div{width:100%;}}& > div{width:0%;height:0.2rem;background:var(--blackTextColor);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);transition:all 0.6s ease-in;}}}}}"]);
_c7 = MlbnavShow;
